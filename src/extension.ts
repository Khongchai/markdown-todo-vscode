...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		...
		vscode.workspace.onDidChangeTextDocument((e) => diagnosticsRuner.update(e.document))
	);

	context.subscriptions.push(
		vscode.workspace.onDidCloseTextDocument((e) => diagnosticsRuner.deleteDocument(e))
	);
