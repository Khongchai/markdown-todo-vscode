...
export function createDiagnosticsRunner(diagnosticsCollection: DiagnosticCollection) {
	function update(document: TextDocument) {
		...
		diagnostics.push(new Diagnostic(range, 'test message', DiagnosticSeverity.Error));
